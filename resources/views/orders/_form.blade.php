...
<div class="modal-body container-fluid">
    ...
    <div class="col-md-5">
        ...
        <div class="row">
            <a href="{{ action('DishesController@show', array('dishes' => $dish, 'isBeingOrdered' => 0)) }}"><img class="img-responsive center-block" src="{{ asset('/userdata/' . $dish->user->id . '/dishes/' . $dish->id . '/picture_sm.jpg') }}" alt="Chef Picture" width="130" height="130" /></a>
        </div>
