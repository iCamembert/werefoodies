...
class User extends Model implements AuthenticatableContract, CanResetPasswordContract {
	 ...
	 * @var array
	 */
	protected $fillable = ['name', 'email', 'password', 'address1', 'address2', 'city', 'state', 'iso_code', 'time_zone', 'home_phone', 'mobile_phone', 'about', 'rating', 'google_place_id'];
    ...
    public function clientOrders()
    {
        ...
        return $this->hasMany('App\Dish', 'user_id')->rightJoin('dishe_order', 'dishes.id', '=', 'dish_order.dish_id')->rightJoin('orders', 'dish_order.order_id', '=', 'orders.id')->select('orders.*', 'dishes.name as dish_name', 'dishes.price as dish_price');
    }
