...
class HomeController extends Controller {
	...
	*/
	...
	{
        $dishesForMap = Dish::all();//Dish::join('users', 'dishes.user_id', '=', 'users.id')->where('users.city_google_place_id', '=', $googlePlaceId)->orderBy('dishes.rating', 'desc')->groupBy('dishes.user_id')->select('dishes.*', 'users.address_google_place_id')->get();
